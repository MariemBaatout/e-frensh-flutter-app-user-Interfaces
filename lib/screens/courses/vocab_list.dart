...
class VocabListScreen extends StatefulWidget {
  const VocabListScreen({Key? key}) : super(key: key);
  ...
  Future<void> getAllCourses() async {
    ...
    setState(() {
      courses = responseData
          ...
          .where((course) => course.type == 'vocabulaire')
          .toList();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Cours De Vocabulaire"),
        centerTitle: true,
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'Recherchez Cours De Vocabulaire',
