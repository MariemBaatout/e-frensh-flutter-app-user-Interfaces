...
class OrthoListScreen extends StatefulWidget {
  const OrthoListScreen({Key? key}) : super(key: key);

  @override
  State<OrthoListScreen> createState() => _OrthoListScreenState();
}

class _OrthoListScreenState extends State<OrthoListScreen> {
  late String _token;
  ...
  Future<void> getAllCourses() async {
    ...
    setState(() {
      courses = responseData
          ...
          .where((course) => course.type == 'orthographe')
          .toList();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Cours D'orthographe"),
        centerTitle: true,
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const CourseHomeScreen()),
            );
          },
        ),
      ),
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'Recherchez cours d\'orthographe',
